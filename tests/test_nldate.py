...
def test_days_before():
    assert nldate.parse("2 days before tomorrow", date(2026,5,13)) == date(2026,5,12)
...
def test_months_after():
    assert nldate.parse("1 month after tomorrow", date(2026, 5, 13)) == date(2026, 6, 14)

def test_years_before():
    assert nldate.parse("3 years before today", date(2026, 5, 13)) == date(2023, 5, 13)

def test_years_after():
    assert nldate.parse("10 years before tomorrow", date(2026, 5, 13)) == date(2016, 5, 14)

def test_all_before():
    assert nldate.parse("2 years, 1 week, 3 months, and 5 days before today", date(2026, 5, 13)) == date(2024, 2, 1)

def test_all_after():
    assert nldate.parse("2 years, 1 week, 3 months, and 5 days after tomorrow", date(2026, 5, 13)) == date(2028, 8, 26)